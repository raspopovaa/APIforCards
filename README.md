...
Пакет `api-client-opti24==2.2.3` опубликован на TestPyPI и поддерживает
...
| Установка | `pyproject.toml`, `uv.lock`, `__init__.py` | Версия `2.2.3`, диапазон Python и публичные импорты совпадают |
