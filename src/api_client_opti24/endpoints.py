...
ENDPOINT_SPECS = (
    ...
    endpoint("check_purchase", "final_prices", "POST", "cards/{card_id}/checkPurchase", "v2", demo=False),
    endpoint("confirm_mpc", "virtual_cards", "POST", "cards/{card_id}/confirmMPC", "v2", demo=False),
    endpoint("create_invite", "invites", "POST", "invites", "v2", demo=False, variants=(route("POST", "invites_free", "v2", demo=True),)),
    endpoint("create_template", "templates", "POST", "vc/templates", "v2"),
    endpoint("create_template_georestriction", "templates", "POST", "vc/templates/{template_id}/georestrictions", "v2"),
    endpoint("create_template_limit", "templates", "POST", "vc/templates/{template_id}/limits", "v2"),
    endpoint("create_template_restriction", "templates", "POST", "vc/templates/{template_id}/restrictions", "v2"),
    ...
    endpoint("delete_template_georestriction", "templates", "DELETE", "vc/templates/{template_id}/georestrictions/{georestriction_id}", "v2", variants=(route("DELETE", "vc/templates/{template_id}/georestrictions/{georestrictions_id}", "v2", demo=True),)),
    endpoint("delete_template_limit", "templates", "DELETE", "vc/templates/{template_id}/limits/{limit_id}", "v2"),
    endpoint("delete_template_restriction", "templates", "DELETE", "vc/templates/{template_id}/restrictions/{restriction_id}", "v2", variants=(route("DELETE", "vc/templates/{template_id}/restrictions/{restrictions_id}", "v2", demo=True),)),
    ...
    endpoint("download_report_file", "reports", "GET", "reports/jobs/{job_id}", "v2", demo=False, timeout="read_heavy"),
    endpoint("download_report_file_v1", "reports", "GET", "getReportFile", "v1", demo=False, timeout="read_heavy"),
    endpoint("generate_payment_qr", "virtual_cards", "POST", "cards/{card_id}/pay", "v2", demo=False),
    endpoint("get_azs_filters", "dictionaries", "GET", "azs/filters", "v2", demo=False, timeout="read_heavy"),
    endpoint("get_azs_list_v1", "dictionaries", "GET", "AZS", "v1", timeout="read_heavy"),
    endpoint("get_azs_list_v2", "dictionaries", "GET", "azs", "v2", demo=False, timeout="read_heavy"),
    endpoint("get_card_detail", "cards", "GET", "cards", "v1", timeout="read_heavy"),
    endpoint("get_card_drivers", "cards", "GET", "cards/{card_id}/drivers", "v2", timeout="read_heavy"),
    endpoint("get_card_groups", "card_group", "GET", "cardGroups", "v1", timeout="read_heavy"),
    endpoint("get_card_transactions_v2", "transactions", "GET", "cards/{card_id}/transactions", "v2", timeout="read_heavy"),
    ...
    endpoint("get_contract_data", "contract", "GET", "getPartContractData", "v1", timeout="read_heavy"),
    endpoint("get_dictionary", "dictionaries", "GET", "getDictionary", "v1", timeout="read_heavy"),
    endpoint("get_documents", "contract", "GET", "documents", "v2", demo=False, timeout="read_heavy"),
    endpoint("get_final_prices", "final_prices", "POST", "cards/{card_id}/calculatePrices", "v2", demo=False),
    ...
    endpoint("get_mpc_qr_list", "virtual_cards", "GET", "MPC", "v2", demo=False, timeout="read_heavy"),
    endpoint("get_payments", "contract", "GET", "getPayments", "v1", timeout="read_heavy"),
    endpoint("get_region_limits", "region_limits", "GET", "regionLimit", "v1", timeout="read_heavy"),
    endpoint("get_report_job_list_v1", "reports", "GET", "getReportJobList", "v1", timeout="read_heavy"),
    ...
    endpoint("get_template_georestrictions", "templates", "GET", "vc/templates/{template_id}/georestrictions", "v2", timeout="read_heavy"),
    endpoint("get_template_limits", "templates", "GET", "vc/templates/{template_id}/limits", "v2", timeout="read_heavy"),
    endpoint("get_template_restrictions", "templates", "GET", "vc/templates/{template_id}/restrictions", "v2", timeout="read_heavy"),
    endpoint("get_templates", "templates", "GET", "vc/templates", "v2", timeout="read_heavy"),
    endpoint("get_transaction_detail", "transactions", "GET", "transactions/{transaction_id}", "v2", timeout="read_heavy"),
    endpoint("get_transactions_v1", "transactions", "GET", "transactions", "v1", demo=False, timeout="read_heavy"),
    endpoint("get_transactions_v2", "transactions", "GET", "transactions", "v2", timeout="read_heavy"),
    ...
    endpoint("prolong_invite", "invites", "POST", "invites/{invite_id}/prolong", "v2", demo=False, variants=(route("POST", "invites/{invite_id}/prolong_free", "v2", demo=True),)),
    ...
    endpoint("update_template", "templates", "POST", "vc/templates/{template_id}", "v2", variants=(route("PUT", "vc/templates/{template_id}", "v2", demo=True),)),
    endpoint("update_template_georestriction", "templates", "POST", "vc/templates/{template_id}/georestrictions/{georestriction_id}", "v2", variants=(route("PUT", "vc/templates/{template_id}/georestrictions/{georestriction_id}", "v2", demo=True), route("PUT", "vc/templates/{template_id}/georestrictions/{georestrictions_id}", "v2", demo=True))),
    endpoint("update_template_limit", "templates", "POST", "vc/templates/{template_id}/limits/{limit_id}", "v2", variants=(route("PUT", "vc/templates/{template_id}/limits/{limit_id}", "v2", demo=True),)),
    endpoint("update_template_restriction", "templates", "POST", "vc/templates/{template_id}/restrictions/{restriction_id}", "v2", variants=(route("PUT", "vc/templates/{template_id}/restrictions/{restriction_id}", "v2", demo=True), route("PUT", "vc/templates/{template_id}/restrictions/{restrictions_id}", "v2", demo=True))),
